...
Array.prototype.forEachPair = function (action, allowDuplicates = true, allowDoubles = true, allowCrossPairs = true) {
    if (allowCrossPairs) {
        const pairs = [];
        this.forEach((val, i) => {
...
Array.prototype.PushOrCreate2D = function (index, value) {
